...
conn.sendImageAsSticker(m.chat, pickRandom(stikerhuuu), m, { packname: "sticker by", author: "ArullOfc" })
}

handler.customPrefix = /^(huuu|Paan|paan|Ajg|Anj|Kntll|Iya|Iy|Y|kntll|anj|ajg|anjir|Anjir|Okee|AWOKAWOAK)$/i
